...
const ScreenOrientation = core.registerPlugin('CapacitorScreenOrientation', {
    web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.CapacitorScreenOrientationWeb()),
});

class CapacitorScreenOrientationWeb extends core.WebPlugin {
    constructor() {
        var _a;
        super();
...
var web = /*#__PURE__*/Object.freeze({
    __proto__: null,
    CapacitorScreenOrientationWeb: CapacitorScreenOrientationWeb
});
